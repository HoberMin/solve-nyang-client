    ...
    <div className='flex min-h-screen items-center justify-center px-4 py-16'>
      ...
      >
        {/* <div className='relative mb-8 overflow-hidden rounded-lg'>
          <div className='aspect-video w-full bg-gradient-to-r from-purple-500/20 to-blue-500/20 backdrop-blur-sm'>
            이미지 영역
          </div>
        </div> */}
        ...
        >
          ...
          <p className='mb-10 text-lg text-gray-300'>
            solved.ac 문제를 풀고 포인트를 모아 귀여운 고양이 캐릭터를
            수집하세요!
          </p>
        </motion.div>
        ...
        <div className='mt-8 flex flex-wrap justify-center gap-4'>
          ...
          <motion.a
            href='/gacha'
            className='rounded-lg border border-white/20 bg-white/5 px-6 py-3 text-lg font-semibold text-white backdrop-blur-sm transition-colors hover:bg-white/10'
            whileHover={{ scale: 1.05 }}
            whileTap={{ scale: 0.95 }}
          >
            캐릭터 뽑기
